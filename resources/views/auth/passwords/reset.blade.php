                            ...
                            <div class="form-bottom">
                                ...
                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" placeholder="Correo..." class="email form-control @if(count($errors) > 0) input-error @endif" id="email">
                                    </div>

                                    <div class="form-group">
                                        <label class="sr-only" for="password">Contraseña</label>
                                        <input type="text" name="password" placeholder="Contraseña..." class="password form-control @if(count($errors) > 0) input-error @endif" id="password">
                                    </div>

                                    <div class="form-group">
                                        <label class="sr-only" for="password_confirmation">Confirmar Contraseña</label>
                                        <input type="text" name="password_confirmation" placeholder="Confirmar Contraseña..." class="password_confirmation form-control @if(count($errors) > 0) input-error @endif" id="password_confirmation">
                                    </div>

                                    <button type="submit" class="btn"><i class="fa fa-btn fa-refresh"></i>Enviar Solicitud</button>
